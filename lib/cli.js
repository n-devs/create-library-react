...
module.exports = async () => {
  ...
  program
    ...
    .option('-t, --template <default>', 'package template to use', /^(default|custom)$/, defaults.template)
...
$ ${chalk.cyan(`cd ${params.shortName} && ${params.manager} run postinstall`)}

test all packages:
$ ${chalk.cyan(`cd ${params.shortName} && ${params.manager} run test`)}
